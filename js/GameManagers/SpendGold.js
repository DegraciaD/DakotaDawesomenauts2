    ...
    setBuyText: function () {
        game.data.buytext = new (me.Renderable.extend({
            ...
            draw: function (renderer) {
                this.font.draw(renderer.getContext(), "PRESS F1-F6 TO BUY, ENTER TO EXIT. Current Gold: " + game.data.gold, this.pos.x, this.pos.y);
                ...
                this.font.draw(renderer.getContext(), "E Ability: Eat Your Creep for Health:  " + game.data.ability2 + " Cost: " + ((game.data.ability2 + 1) * 10), this.pos.x, this.pos.y + 200);
                this.font.draw(renderer.getContext(), "C Ability: Throw Your Spear: " + game.data.ability3 + " Cost: " + ((game.data.skill3 + 1) * 10), this.pos.x, this.pos.y + 240);
            }
